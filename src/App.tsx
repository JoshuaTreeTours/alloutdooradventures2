...
const MexicoCitySlugRedirect = () => (
  <RouteRedirect to="/destinations/mexico/mexico-city" />
);
...
const MexicoCityToursSlugRedirect = ({
  ...
  <RouteRedirect
    to={`/destinations/mexico/mexico-city/tours/${params.tourSlug}`}
  />
);
...
const MexicoCityBookSlugRedirect = ({
  ...
  <RouteRedirect
    to={`/destinations/mexico/mexico-city/tours/${params.tourSlug}/book`}
  />
);
  ...
  return (
    <>
      ...
      <Switch>
        ...
        />
        <Route
          path={ENGINE6_SAN_DIEGO_SUNDAY_BRUNCH_CRUISE_ROUTE}
          component={Engine6SpecimenRoute}
        />
        <Route
        ...
        />
        <Route
          path={ENGINE6_JOSHUA_TREE_ROCK_SCRAMBLING_ROUTE}
          component={Engine6SpecimenRoute}
        />
        <Route
        ...
        />
        <Route
          path={ENGINE6_SAN_DIEGO_CLASSIC_SAIL_CHARTER_ROUTE}
          component={Engine6SpecimenRoute}
        />
        <Route
        ...
        />
        <Route
          path={ENGINE6_SAN_DIEGO_FINEST_CITY_TOUR_ROUTE}
          component={Engine6SpecimenRoute}
        />
        <Route
          path={ENGINE6_SAN_DIEGO_HARBOR_SPEED_BOAT_ADVENTURE_ROUTE}
          component={Engine6SpecimenRoute}
        />
        <Route
          path={ENGINE6_SAN_DIEGO_SAILING_CHARTERED_EXPERIENCE_ROUTE}
          component={Engine6SpecimenRoute}
        />
        <Route
          path={ENGINE6_SAN_DIEGO_TIJUANA_BORDER_TOUR_ROUTE}
          component={Engine6SpecimenRoute}
        />
        <Route
        ...
        <Route
          path="/destinations/mexico/ciudad-de-mexico"
          component={MexicoCitySlugRedirect}
        />
        <Route
          path="/destinations/mexico/ciudad-de-mexico/tours"
          component={() => (
            <RouteRedirect to="/destinations/mexico/mexico-city/tours" />
          )}
        />
        <Route
          path="/destinations/mexico/ciudad-de-mexico/tours/:tourSlug"
          component={MexicoCityToursSlugRedirect}
        />
        <Route
          path="/destinations/mexico/ciudad-de-mexico/tours/:tourSlug/book"
