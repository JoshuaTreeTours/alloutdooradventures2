...
export default function CanadaTourRoute({ params }: Props) {
  const tour = getEngine2CanadaTourBySlug(params.province, params.city, params.tourSlug);
  if (!tour) return <main className="mx-auto max-w-4xl px-6 py-16">Tour not found</main>;
