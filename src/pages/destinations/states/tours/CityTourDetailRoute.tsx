...
import { getTourSeo } from "../../../../lib/seo/getTourSeo";
import { isPilotTourRoute } from "../../../../config/pilotPrerenderRoutes";
import {
  buildBreadcrumbList,
...
export default function CityTourDetailRoute({
  ...
  const tourSeo = tour ? getTourSeo({ tour, pathname: canonicalUrl }) : null;
  const seoDescription = tourSeo?.description;
  ...
  const seoMeta = getTourSeo({ tour, pathname: canonicalUrl });
  const relatedTours = (
