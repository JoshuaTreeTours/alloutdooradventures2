...
import { europeTourRows } from "./europeTours.generated";

type CsvRow = (typeof europeTourRows)[keyof typeof europeTourRows][number];
...
export const europeTours: Tour[] = [
  ...buildToursFromRows(europeTourRows.cycling, "cycling"),
  ...buildToursFromRows(europeTourRows.hiking, "hiking"),
  ...buildToursFromRows(europeTourRows.canoeing, "canoeing"),
];
