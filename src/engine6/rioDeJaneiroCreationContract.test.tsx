...
import { RIO_DE_JANEIRO_VIATOR_PUBLIC_PRODUCT_CODES } from "./rioDeJaneiroViatorPublicRatings";

(globalThis as { location?: { pathname: string } }).location = {
  pathname: "/",
};

const rioDeJaneiroFixtures = ENGINE6_VALIDATION_FIXTURES.filter(fixture =>
...
describe("Rio de Janeiro Engine6 creation contract", () => {
  it("covers every selected Rio de Janeiro product code", () => {
    expect(rioDeJaneiroFixtures.map(fixture => fixture.productCode).sort()).toEqual(
      [...RIO_DE_JANEIRO_VIATOR_PUBLIC_PRODUCT_CODES].sort()
    );
  });

  it.each(rioDeJaneiroFixtures)("validates hardened contract for %s", fixture => {
