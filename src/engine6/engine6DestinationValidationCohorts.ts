...
export const ENGINE6_DESTINATION_VALIDATION_COHORTS: Engine6DestinationValidationCohort[] =
  [
    ...
    },
    {
      label: "Mexico City",
      matches: tour =>
        /\/mexico\/mexico-city\//i.test(tour.canonicalPath) ||
        (/\bmexico city\b/i.test(tour.city) && /\bmexico\b/i.test(tour.state)),
      requireUniqueListingHeroes: true,
    },
    {
      label: "Cancun",
      matches: tour =>
        /\/mexico\/cancun\//i.test(tour.canonicalPath) ||
        (/\bcancun\b/i.test(tour.city) && /\bmexico\b/i.test(tour.state)),
      requireUniqueListingHeroes: true,
    },
    {
    ...
    },
    {
      label: "Cusco",
      matches: tour =>
        /\/peru\/cusco\//i.test(tour.canonicalPath) ||
        (/\bcusco\b/i.test(tour.city) && /\bperu\b/i.test(tour.state)),
      requireUniqueListingHeroes: true,
    },
    {
      label: "Lima",
      matches: tour =>
        /\/peru\/lima\//i.test(tour.canonicalPath) ||
        (/\blima\b/i.test(tour.city) && /\bperu\b/i.test(tour.state)),
      requireUniqueListingHeroes: true,
    },
    {
    ...
    },
    {
      label: "Tokyo",
      matches: tour =>
        /\/japan\/tokyo\//i.test(tour.canonicalPath) ||
        (/\btokyo\b/i.test(tour.city) && /\bjapan\b/i.test(tour.state)),
      requireUniqueListingHeroes: true,
    },
    {
      label: "Kyoto",
      matches: tour =>
        /\/japan\/kyoto\//i.test(tour.canonicalPath) ||
        (/\bkyoto\b/i.test(tour.city) && /\bjapan\b/i.test(tour.state)),
      requireUniqueListingHeroes: true,
    },
    {
      label: "Osaka",
      matches: tour =>
        /\/japan\/osaka\//i.test(tour.canonicalPath) ||
        (/\bosaka\b/i.test(tour.city) && /\bjapan\b/i.test(tour.state)),
      requireUniqueListingHeroes: true,
    },
    {
      label: "Bangkok",
      matches: tour =>
        /\/thailand\/bangkok\//i.test(tour.canonicalPath) ||
        (/\bbangkok\b/i.test(tour.city) && /\bthailand\b/i.test(tour.state)),
      requireUniqueListingHeroes: true,
    },
    {
      label: "Singapore",
      matches: tour =>
        /\/singapore\/singapore\//i.test(tour.canonicalPath) ||
        (/\bsingapore\b/i.test(tour.city) && /\bsingapore\b/i.test(tour.state)),
      requireUniqueListingHeroes: true,
    },
    {
      label: "Bali",
      matches: tour =>
        /\/indonesia\/bali\//i.test(tour.canonicalPath) ||
        (/\bbali\b/i.test(tour.city) && /\bindonesia\b/i.test(tour.state)),
      requireUniqueListingHeroes: true,
    },
    {
      label: "Seoul",
      matches: tour =>
        /\/south-korea\/seoul\//i.test(tour.canonicalPath) ||
        (/\bseoul\b/i.test(tour.city) && /\bsouth korea\b/i.test(tour.state)),
      requireUniqueListingHeroes: true,
    },
    {
      label: "Sydney",
    ...
    },
    {
      label: "Cairns",
      matches: tour =>
        /\/australia\/cairns\//i.test(tour.canonicalPath) ||
        (/\bcairns\b/i.test(tour.city) && /\baustralia\b/i.test(tour.state)),
      requireUniqueListingHeroes: true,
    },
    {
      label: "Melbourne",
      matches: tour =>
        /\/australia\/melbourne\//i.test(tour.canonicalPath) ||
        (/\bmelbourne\b/i.test(tour.city) && /\baustralia\b/i.test(tour.state)),
      requireUniqueListingHeroes: true,
    },
    {
      label: "Queenstown",
      matches: tour =>
        /\/new-zealand\/queenstown\//i.test(tour.canonicalPath) ||
        (/\bqueenstown\b/i.test(tour.city) &&
          /\bnew zealand\b/i.test(tour.state)),
      requireUniqueListingHeroes: true,
    },
    {
      label: "Paris",
