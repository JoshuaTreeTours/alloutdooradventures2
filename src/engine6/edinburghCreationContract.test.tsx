...
import { EDINBURGH_VIATOR_PUBLIC_PRODUCT_CODES } from "./edinburghViatorPublicRatings";

(globalThis as { location?: { pathname: string } }).location = {
  pathname: "/",
};

const edinburghFixtures = ENGINE6_VALIDATION_FIXTURES.filter(fixture =>
...
describe("Edinburgh Engine6 creation contract", () => {
  it("covers every selected Edinburgh product code", () => {
    expect(edinburghFixtures.map(fixture => fixture.productCode).sort()).toEqual(
      [...EDINBURGH_VIATOR_PUBLIC_PRODUCT_CODES].sort()
    );
  });

  it.each(edinburghFixtures)("validates hardened contract for %s", fixture => {
