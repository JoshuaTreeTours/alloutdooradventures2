...
import { KONA_VIATOR_PUBLIC_PRODUCT_CODES } from "./konaViatorPublicRatings";

(globalThis as { location?: { pathname: string } }).location = {
  pathname: "/",
};

const konaFixtures = ENGINE6_VALIDATION_FIXTURES.filter(fixture =>
  KONA_VIATOR_PUBLIC_PRODUCT_CODES.includes(fixture.productCode)
);
...
describe("Kona Engine6 creation contract", () => {
  it.each(konaFixtures)("validates hardened contract for %s", fixture => {
