...
const moabFixtures = ENGINE6_VALIDATION_FIXTURES.filter(fixture =>
  MOAB_VIATOR_PUBLIC_PRODUCT_CODES.includes(fixture.productCode)
);
...
describe("Moab Engine6 creation contract", () => {
  it.each(moabFixtures)("validates hardened contract for %s", fixture => {
