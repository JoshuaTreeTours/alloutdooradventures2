...
import { MAUI_VIATOR_PUBLIC_PRODUCT_CODES } from "./mauiViatorPublicRatings";

(globalThis as { location?: { pathname: string } }).location = {
  pathname: "/",
};

const mauiFixtures = ENGINE6_VALIDATION_FIXTURES.filter(fixture =>
  MAUI_VIATOR_PUBLIC_PRODUCT_CODES.includes(fixture.productCode)
);
...
describe("Maui Engine6 creation contract", () => {
  it.each(mauiFixtures)("validates hardened contract for %s", fixture => {
