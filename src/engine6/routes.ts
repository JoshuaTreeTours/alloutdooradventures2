...
export const ENGINE6_SOAR_ABOVE_SANTA_BARBARA_PRODUCT_CODE = "331438P1";
export const ENGINE6_SOAR_ABOVE_SANTA_BARBARA_ROUTE =
...
const ENGINE6_ROUTE_PRODUCT_CODE_ENTRIES = [
  ...
  [
    ENGINE6_SOAR_ABOVE_SANTA_BARBARA_ROUTE,
    ENGINE6_SOAR_ABOVE_SANTA_BARBARA_PRODUCT_CODE,
  ],
