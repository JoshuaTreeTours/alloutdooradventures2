...
export const ENGINE6_SAN_FRANCISCO_YOSEMITE_3_DAY_CAMPING_PRODUCT_CODE = "3454YE3D";
...
export const ENGINE6_LOS_ANGELES_FULL_DAY_HIGHLIGHTS_PRODUCT_CODE =
  "170119P1";
...
export const ENGINE6_JOSHUA_TREE_HALF_DAY_SMALL_GROUP_PRODUCT_CODE =
  "335698P7";
...
export const ENGINE6_JOSHUA_TREE_PROFESSIONAL_STARGAZING_PRODUCT_CODE = "445161P1";
...
const ENGINE6_ROUTE_PRODUCT_CODE_ENTRIES = [
  ...
  [ENGINE6_LOS_ANGELES_GRAND_TOUR_ROUTE, ENGINE6_LOS_ANGELES_GRAND_TOUR_PRODUCT_CODE],
  [
