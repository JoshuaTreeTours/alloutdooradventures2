...
export const ENGINE6_FORT_LAUDERDALE_PRIVATE_EVERGLADES_AIRBOAT_PRODUCT_CODE =
  "76145P2";
export const ENGINE6_FORT_LAUDERDALE_PRIVATE_EVERGLADES_AIRBOAT_ROUTE =
...
export const ENGINE6_FORT_LAUDERDALE_SHARED_BIG_GAME_FISHING_PRODUCT_CODE =
  "118958P8";
export const ENGINE6_FORT_LAUDERDALE_SHARED_BIG_GAME_FISHING_ROUTE =
...
const ENGINE6_ROUTE_PRODUCT_CODE_ENTRIES = [
  ...
  [
    ...
    ENGINE6_FORT_LAUDERDALE_PRIVATE_EVERGLADES_AIRBOAT_PRODUCT_CODE,
  ],
  [
  ...
  [
    ...
    ENGINE6_FORT_LAUDERDALE_SHARED_BIG_GAME_FISHING_PRODUCT_CODE,
  ],
