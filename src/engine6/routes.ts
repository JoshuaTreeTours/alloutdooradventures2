...
export const ENGINE6_GRAND_CANYON_NORTH_CANYON_HELICOPTER_PRODUCT_CODE =
  "6613P14";
export const ENGINE6_GRAND_CANYON_NORTH_CANYON_HELICOPTER_ROUTE =
  "/destinations/arizona/grand-canyon-national-park/tours/north-canyon-helicopter-tour-6613P14";
...
const ENGINE6_ROUTE_PRODUCT_CODE_ENTRIES = [
  ...
  [
    ENGINE6_GRAND_CANYON_NORTH_CANYON_HELICOPTER_ROUTE,
    ENGINE6_GRAND_CANYON_NORTH_CANYON_HELICOPTER_PRODUCT_CODE,
  ],
  [
