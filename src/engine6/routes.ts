...
export const ENGINE6_NYC_AMERICAN_MUSEUM_NATURAL_HISTORY_PRODUCT_CODE =
  "2396AMNH";
export const ENGINE6_NYC_AMERICAN_MUSEUM_NATURAL_HISTORY_ROUTE =
  "/destinations/new-york/new-york/tours/american-museum-of-natural-history";
...
const ENGINE6_ROUTE_PRODUCT_CODE_ENTRIES = [
  ...
  [
    ENGINE6_NYC_AMERICAN_MUSEUM_NATURAL_HISTORY_ROUTE,
    ENGINE6_NYC_AMERICAN_MUSEUM_NATURAL_HISTORY_PRODUCT_CODE,
  ],
