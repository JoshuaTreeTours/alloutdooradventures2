...
export const ENGINE6_YOSEMITE_BEST_OF_SEQUOIAS_GLACIER_POINT_PRODUCT_CODE =
  "3454P41";
export const ENGINE6_YOSEMITE_BEST_OF_SEQUOIAS_GLACIER_POINT_ROUTE =
  "/destinations/california/yosemite/tours/best-of-yosemite-sequoias-glacier-point-3454P41";
export const ENGINE6_YOSEMITE_FULL_DAY_GLACIER_POINT_PRODUCT_CODE = "18808P1";
export const ENGINE6_YOSEMITE_FULL_DAY_GLACIER_POINT_ROUTE =
  "/destinations/california/yosemite/tours/full-day-yosemite-glacier-point-tour-18808P1";
export const ENGINE6_YOSEMITE_MARIPOSA_GROVE_WAWONA_PRODUCT_CODE = "391021P3";
export const ENGINE6_YOSEMITE_MARIPOSA_GROVE_WAWONA_ROUTE =
  "/destinations/california/yosemite/tours/mariposa-grove-sequoias-wawona-tour-391021P3";
...
const ENGINE6_ROUTE_PRODUCT_CODE_ENTRIES = [
  ...
  [
    ENGINE6_YOSEMITE_BEST_OF_SEQUOIAS_GLACIER_POINT_ROUTE,
    ENGINE6_YOSEMITE_BEST_OF_SEQUOIAS_GLACIER_POINT_PRODUCT_CODE,
  ],
  [
    ENGINE6_YOSEMITE_FULL_DAY_GLACIER_POINT_ROUTE,
    ENGINE6_YOSEMITE_FULL_DAY_GLACIER_POINT_PRODUCT_CODE,
  ],
  [
    ENGINE6_YOSEMITE_MARIPOSA_GROVE_WAWONA_ROUTE,
    ENGINE6_YOSEMITE_MARIPOSA_GROVE_WAWONA_PRODUCT_CODE,
  ],
  [
