...
export const ENGINE6_MIAMI_EVERGLADES_TRANSPORT_PRODUCT_CODE = "21428P2";
export const ENGINE6_MIAMI_EVERGLADES_TRANSPORT_ROUTE =
  "/destinations/florida/miami/tours/everglades-small-group-tour-from-miami-with-transportation";
export const ENGINE6_MIAMI_EVERGLADES_ADVENTURE_PRODUCT_CODE = "5221EVERGLADES";
export const ENGINE6_MIAMI_EVERGLADES_ADVENTURE_ROUTE =
  "/destinations/florida/miami/tours/everglades-airboat-adventure-with-hotel-transport-from-miami";
export const ENGINE6_MIAMI_SPEEDBOAT_SIGHTSEEING_PRODUCT_CODE = "35834P1";
export const ENGINE6_MIAMI_SPEEDBOAT_SIGHTSEEING_ROUTE =
  "/destinations/florida/miami/tours/miami-speedboat-sightseeing-tour";
export const ENGINE6_MIAMI_SPEEDBOAT_PRODUCT_CODE = "5441BOAT";
export const ENGINE6_MIAMI_SPEEDBOAT_ROUTE =
  "/destinations/florida/miami/tours/miami-speedboat-tour";
export const ENGINE6_MIAMI_MILLIONAIRES_ROW_ISLQUESS_PRODUCT_CODE =
  "3587ISLQUESS";
export const ENGINE6_MIAMI_MILLIONAIRES_ROW_ISLQUESS_ROUTE =
  "/destinations/florida/miami/tours/millionaires-row-cruise-3587islquess";
export const ENGINE6_MIAMI_MILLIONAIRES_ROW_120303_PRODUCT_CODE = "120303P9";
export const ENGINE6_MIAMI_MILLIONAIRES_ROW_120303_ROUTE =
  "/destinations/florida/miami/tours/millionaires-row-cruise-120303p9";
export const ENGINE6_MIAMI_BISCAYNE_SIGHTSEEING_PRODUCT_CODE = "8836P1";
export const ENGINE6_MIAMI_BISCAYNE_SIGHTSEEING_ROUTE =
  "/destinations/florida/miami/tours/biscayne-bay-sightseeing-cruise";
export const ENGINE6_MIAMI_LITTLE_HAVANA_FOOD_PRODUCT_CODE = "5304HAVANA";
export const ENGINE6_MIAMI_LITTLE_HAVANA_FOOD_ROUTE =
  "/destinations/florida/miami/tours/little-havana-food-and-walking-tour";
export const ENGINE6_MIAMI_LITTLE_HAVANA_CULTURAL_PRODUCT_CODE = "51540P1";
export const ENGINE6_MIAMI_LITTLE_HAVANA_CULTURAL_ROUTE =
  "/destinations/florida/miami/tours/little-havana-cultural-walking-and-food-tour";
...
const ENGINE6_ROUTE_PRODUCT_CODE_ENTRIES = [
  ...
  [
    ...
    ENGINE6_MIAMI_EVERGLADES_TRANSPORT_PRODUCT_CODE,
  ],
  [
    ENGINE6_MIAMI_EVERGLADES_ADVENTURE_ROUTE,
    ENGINE6_MIAMI_EVERGLADES_ADVENTURE_PRODUCT_CODE,
  ],
  [
    ENGINE6_MIAMI_SPEEDBOAT_SIGHTSEEING_ROUTE,
    ENGINE6_MIAMI_SPEEDBOAT_SIGHTSEEING_PRODUCT_CODE,
  ],
  [ENGINE6_MIAMI_SPEEDBOAT_ROUTE, ENGINE6_MIAMI_SPEEDBOAT_PRODUCT_CODE],
  [
    ENGINE6_MIAMI_MILLIONAIRES_ROW_ISLQUESS_ROUTE,
    ENGINE6_MIAMI_MILLIONAIRES_ROW_ISLQUESS_PRODUCT_CODE,
  ],
  [
    ENGINE6_MIAMI_MILLIONAIRES_ROW_120303_ROUTE,
    ENGINE6_MIAMI_MILLIONAIRES_ROW_120303_PRODUCT_CODE,
  ],
  [
    ENGINE6_MIAMI_BISCAYNE_SIGHTSEEING_ROUTE,
    ENGINE6_MIAMI_BISCAYNE_SIGHTSEEING_PRODUCT_CODE,
  ],
  [
    ENGINE6_MIAMI_LITTLE_HAVANA_FOOD_ROUTE,
    ENGINE6_MIAMI_LITTLE_HAVANA_FOOD_PRODUCT_CODE,
  ],
  [
    ENGINE6_MIAMI_LITTLE_HAVANA_CULTURAL_ROUTE,
    ENGINE6_MIAMI_LITTLE_HAVANA_CULTURAL_PRODUCT_CODE,
  ],
] as const;
