...
export const ENGINE6_MIAMI_EVERGLADES_TRANSPORT_ROUTE =
  "/destinations/florida/miami/tours/everglades-tour-from-miami-with-transportation";
export const ENGINE6_MIAMI_EVERGLADES_AIRBOAT_PRODUCT_CODE = "5221EVERGLADES";
export const ENGINE6_MIAMI_EVERGLADES_AIRBOAT_ROUTE =
  "/destinations/florida/miami/tours/miami-everglades-airboat-adventure-with-transport";
...
export const ENGINE6_MIAMI_SPEEDBOAT_SIGHTSEEING_ROUTE =
  "/destinations/florida/miami/tours/speedboat-sightseeing-tour-in-miami";
...
export const ENGINE6_MIAMI_MILLIONAIRES_ROW_3587_PRODUCT_CODE = "3587ISLQUESS";
export const ENGINE6_MIAMI_MILLIONAIRES_ROW_3587_ROUTE =
...
export const ENGINE6_MIAMI_BISCAYNE_CRUISE_PRODUCT_CODE = "8836P1";
export const ENGINE6_MIAMI_BISCAYNE_CRUISE_ROUTE =
  "/destinations/florida/miami/tours/sightseeing-cruise-of-biscayne-bay";
...
const ENGINE6_ROUTE_PRODUCT_CODE_ENTRIES = [
  ...
  [
    ...
    ENGINE6_MIAMI_EVERGLADES_AIRBOAT_PRODUCT_CODE,
  ],
  [
  ...
  [
    ENGINE6_MIAMI_MILLIONAIRES_ROW_3587_ROUTE,
    ENGINE6_MIAMI_MILLIONAIRES_ROW_3587_PRODUCT_CODE,
  ],
  [
  ...
  [
    ...
    ENGINE6_MIAMI_BISCAYNE_CRUISE_PRODUCT_CODE,
  ],
  [
