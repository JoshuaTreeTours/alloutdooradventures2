...
export const ENGINE6_FORT_LAUDERDALE_SEVEN_ISLES_KAYAK_PRODUCT_CODE =
  "169688P1";
export const ENGINE6_FORT_LAUDERDALE_SEVEN_ISLES_KAYAK_ROUTE =
  "/destinations/florida/fort-lauderdale/tours/seven-isles-of-fort-lauderdale-kayak-tour";
export const ENGINE6_FORT_LAUDERDALE_SEABOB_SNORKEL_REEF_PRODUCT_CODE =
  "88157P1";
export const ENGINE6_FORT_LAUDERDALE_SEABOB_SNORKEL_REEF_ROUTE =
  "/destinations/florida/fort-lauderdale/tours/seabob-snorkel-reef-tour-fort-lauderdale";
...
const ENGINE6_ROUTE_PRODUCT_CODE_ENTRIES = [
  ...
  [
    ENGINE6_FORT_LAUDERDALE_SEVEN_ISLES_KAYAK_ROUTE,
    ENGINE6_FORT_LAUDERDALE_SEVEN_ISLES_KAYAK_PRODUCT_CODE,
  ],
  [
    ENGINE6_FORT_LAUDERDALE_SEABOB_SNORKEL_REEF_ROUTE,
    ENGINE6_FORT_LAUDERDALE_SEABOB_SNORKEL_REEF_PRODUCT_CODE,
  ],
