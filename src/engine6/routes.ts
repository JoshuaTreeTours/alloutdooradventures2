...
export const ENGINE6_JOSHUA_TREE_SUNSET_TOUR_PRODUCT_CODE = "335698P7";
export const ENGINE6_JOSHUA_TREE_SUNSET_TOUR_ROUTE =
  "/destinations/california/joshua-tree/tours/joshua-tree-national-park-sightseeing-adventure-tour-335698p7";
...
const ENGINE6_ROUTE_PRODUCT_CODE_ENTRIES = [
  ...
  [
    ENGINE6_JOSHUA_TREE_SUNSET_TOUR_ROUTE,
    ENGINE6_JOSHUA_TREE_SUNSET_TOUR_PRODUCT_CODE,
  ],
  [
