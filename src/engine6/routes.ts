...
export const ENGINE6_MIAMI_MILLIONAIRES_ROW_CRUISE_PRODUCT_CODE = "3587ISLQUESS";
export const ENGINE6_MIAMI_MILLIONAIRES_ROW_CRUISE_ROUTE =
...
const ENGINE6_ROUTE_PRODUCT_CODE_ENTRIES = [
  ...
  [
    ENGINE6_MIAMI_MILLIONAIRES_ROW_CRUISE_ROUTE,
    ENGINE6_MIAMI_MILLIONAIRES_ROW_CRUISE_PRODUCT_CODE,
  ],
  [
