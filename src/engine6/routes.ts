...
export const ENGINE6_FORT_LAUDERDALE_VENICE_CRUISE_PRODUCT_CODE = "57834P1";
export const ENGINE6_FORT_LAUDERDALE_VENICE_CRUISE_ROUTE =
  "/destinations/florida/fort-lauderdale/tours/venice-of-america-fort-lauderdale-cruise";
export const ENGINE6_FORT_LAUDERDALE_DRIFT_FISHING_PRODUCT_CODE = "118958P5";
export const ENGINE6_FORT_LAUDERDALE_DRIFT_FISHING_ROUTE =
  "/destinations/florida/fort-lauderdale/tours/4-hour-drift-fishing";
...
const ENGINE6_ROUTE_PRODUCT_CODE_ENTRIES = [
  ...
  [
    ...
    ENGINE6_FORT_LAUDERDALE_VENICE_CRUISE_PRODUCT_CODE,
  ],
  [
    ENGINE6_FORT_LAUDERDALE_DRIFT_FISHING_ROUTE,
    ENGINE6_FORT_LAUDERDALE_DRIFT_FISHING_PRODUCT_CODE,
  ],
