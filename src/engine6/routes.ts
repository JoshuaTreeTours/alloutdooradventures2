...
export const ENGINE6_FORT_LAUDERDALE_EBIKE_PRODUCT_CODE = "383300P4";
...
export const ENGINE6_SAN_DIEGO_WHALE_WATCH_PRODUCT_CODE = "5144WHALE";
...
const ENGINE6_OVERLAP_REPLACEMENT_CONFIGS: Engine6OverlapReplacementConfig[] = [
  ...
  {
    productCode: ENGINE6_FORT_LAUDERDALE_EBIKE_PRODUCT_CODE,
    canonicalPath: ENGINE6_FORT_LAUDERDALE_EBIKE_ROUTE,
  },
  {
    productCode: ENGINE6_SAN_DIEGO_WHALE_WATCH_PRODUCT_CODE,
    canonicalPath: ENGINE6_SAN_DIEGO_WHALE_WATCH_ROUTE,
  },
];
