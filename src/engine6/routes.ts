...
export const ENGINE6_GRAND_CANYON_SOUTH_RIM_BUS_PRODUCT_CODE = "18262P1";
export const ENGINE6_GRAND_CANYON_SOUTH_RIM_BUS_ROUTE =
  "/destinations/nevada/las-vegas/tours/grand-canyon-national-park-bus-tour";
...
const ENGINE6_ROUTE_PRODUCT_CODE_ENTRIES = [
  ...
  [
    ENGINE6_GRAND_CANYON_SOUTH_RIM_BUS_ROUTE,
    ENGINE6_GRAND_CANYON_SOUTH_RIM_BUS_PRODUCT_CODE,
  ],
