...
export const ENGINE6_LAS_VEGAS_RED_ROCK_EBIKE_GUIDED_PRODUCT_CODE =
  "7079RREBIKE";
export const ENGINE6_LAS_VEGAS_RED_ROCK_EBIKE_GUIDED_ROUTE =
  "/destinations/nevada/las-vegas/tours/red-rock-canyon-electric-bike-tour";
export const ENGINE6_LAS_VEGAS_RED_ROCK_EBIKE_OPERATOR_PRODUCT_CODE =
  "5109P6";
export const ENGINE6_LAS_VEGAS_RED_ROCK_EBIKE_OPERATOR_ROUTE =
  "/destinations/nevada/las-vegas/tours/electric-bike-tour-of-red-rock-canyon";
export const ENGINE6_LAS_VEGAS_EBIKE_RENTAL_SELF_GUIDED_PRODUCT_CODE =
  "436985P2";
export const ENGINE6_LAS_VEGAS_EBIKE_RENTAL_SELF_GUIDED_ROUTE =
  "/destinations/nevada/las-vegas/tours/las-vegas-electric-bike-rental-4-hour-self-guided-tour";
export const ENGINE6_LAS_VEGAS_RED_ROCK_SELF_GUIDED_EBIKE_PRODUCT_CODE =
  "60124P1";
export const ENGINE6_LAS_VEGAS_RED_ROCK_SELF_GUIDED_EBIKE_ROUTE =
  "/destinations/nevada/las-vegas/tours/red-rock-canyon-self-guided-electric-bike-tour";
export const ENGINE6_LAS_VEGAS_HISTORICAL_RAILROAD_EBIKE_PRODUCT_CODE =
  "354611P1";
export const ENGINE6_LAS_VEGAS_HISTORICAL_RAILROAD_EBIKE_ROUTE =
  "/destinations/nevada/las-vegas/tours/historical-railroad-trail-ebike-tour";
export const ENGINE6_LAS_VEGAS_ARTS_DISTRICT_EBIKE_PRODUCT_CODE =
  "5615689P4";
export const ENGINE6_LAS_VEGAS_ARTS_DISTRICT_EBIKE_ROUTE =
  "/destinations/nevada/las-vegas/tours/arts-district-e-bike-tour";
export const ENGINE6_LAS_VEGAS_MUSTANG_TRAIL_MTB_PRODUCT_CODE = "5109_CY003";
export const ENGINE6_LAS_VEGAS_MUSTANG_TRAIL_MTB_ROUTE =
  "/destinations/nevada/las-vegas/tours/guided-mountain-bike-tour-of-mustang-trail-in-red-rock-canyon";
...
const ENGINE6_ROUTE_PRODUCT_CODE_ENTRIES = [
  ...
  [
    ...
    ENGINE6_LAS_VEGAS_RED_ROCK_EBIKE_GUIDED_PRODUCT_CODE,
  ],
  [
    ENGINE6_LAS_VEGAS_RED_ROCK_EBIKE_OPERATOR_ROUTE,
    ENGINE6_LAS_VEGAS_RED_ROCK_EBIKE_OPERATOR_PRODUCT_CODE,
  ],
  [
    ENGINE6_LAS_VEGAS_EBIKE_RENTAL_SELF_GUIDED_ROUTE,
    ENGINE6_LAS_VEGAS_EBIKE_RENTAL_SELF_GUIDED_PRODUCT_CODE,
  ],
  [
    ENGINE6_LAS_VEGAS_RED_ROCK_SELF_GUIDED_EBIKE_ROUTE,
    ENGINE6_LAS_VEGAS_RED_ROCK_SELF_GUIDED_EBIKE_PRODUCT_CODE,
  ],
  [
    ENGINE6_LAS_VEGAS_HISTORICAL_RAILROAD_EBIKE_ROUTE,
    ENGINE6_LAS_VEGAS_HISTORICAL_RAILROAD_EBIKE_PRODUCT_CODE,
  ],
  [
  ...
  [
    ...
    ENGINE6_LAS_VEGAS_MUSTANG_TRAIL_MTB_PRODUCT_CODE,
  ],
