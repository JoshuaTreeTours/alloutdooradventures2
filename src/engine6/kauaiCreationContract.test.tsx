...
import { KAUAI_VIATOR_PUBLIC_PRODUCT_CODES } from "./kauaiViatorPublicRatings";

(globalThis as { location?: { pathname: string } }).location = {
  pathname: "/",
};

const kauaiFixtures = ENGINE6_VALIDATION_FIXTURES.filter(fixture =>
  KAUAI_VIATOR_PUBLIC_PRODUCT_CODES.includes(fixture.productCode)
);
...
describe("Kauai Engine6 creation contract", () => {
  it.each(kauaiFixtures)("validates hardened contract for %s", fixture => {
