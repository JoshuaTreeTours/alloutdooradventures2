...
import { BRYCE_CANYON_NATIONAL_PARK_VIATOR_PUBLIC_PRODUCT_CODES } from "./bryceCanyonNationalParkViatorPublicRatings";

(globalThis as { location?: { pathname: string } }).location = {
  pathname: "/",
};

const bryceFixtures = ENGINE6_VALIDATION_FIXTURES.filter(fixture =>
...
describe("Bryce Canyon National Park Engine6 creation contract", () => {
  it("covers every selected Bryce Canyon product code", () => {
    expect(bryceFixtures.map(fixture => fixture.productCode).sort()).toEqual(
      [...BRYCE_CANYON_NATIONAL_PARK_VIATOR_PUBLIC_PRODUCT_CODES].sort()
    );
  });

  it.each(bryceFixtures)("validates hardened contract for %s", fixture => {
