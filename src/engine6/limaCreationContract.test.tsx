...
import { LIMA_VIATOR_PUBLIC_PRODUCT_CODES } from "./limaViatorPublicRatings";

(globalThis as { location?: { pathname: string } }).location = {
  pathname: "/",
};

const limaFixtures = ENGINE6_VALIDATION_FIXTURES.filter(fixture =>
...
describe("Lima Engine6 creation contract", () => {
  it("covers every selected Lima product code", () => {
    expect(limaFixtures.map(fixture => fixture.productCode).sort()).toEqual(
      [...LIMA_VIATOR_PUBLIC_PRODUCT_CODES].sort()
    );
  });

  it.each(limaFixtures)("validates hardened contract for %s", fixture => {
