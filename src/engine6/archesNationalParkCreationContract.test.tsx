...
import { ARCHES_NATIONAL_PARK_VIATOR_PUBLIC_PRODUCT_CODES } from "./archesNationalParkViatorPublicRatings";

(globalThis as { location?: { pathname: string } }).location = {
  pathname: "/",
};

const archesFixtures = ENGINE6_VALIDATION_FIXTURES.filter(fixture =>
...
describe("Arches National Park Engine6 creation contract", () => {
  it("covers every selected Arches product code", () => {
    expect(archesFixtures.map(fixture => fixture.productCode).sort()).toEqual(
      [...ARCHES_NATIONAL_PARK_VIATOR_PUBLIC_PRODUCT_CODES].sort()
    );
  });

  it.each(archesFixtures)("validates hardened contract for %s", fixture => {
