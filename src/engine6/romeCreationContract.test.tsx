...
import { ROME_VIATOR_PUBLIC_PRODUCT_CODES } from "./romeViatorPublicRatings";

(globalThis as { location?: { pathname: string } }).location = {
  pathname: "/",
};

const romeFixtures = ENGINE6_VALIDATION_FIXTURES.filter(fixture =>
...
describe("Rome Engine6 creation contract", () => {
  it("covers every selected Rome product code", () => {
    expect(romeFixtures.map(fixture => fixture.productCode).sort()).toEqual(
      [...ROME_VIATOR_PUBLIC_PRODUCT_CODES].sort()
    );
  });

  it.each(romeFixtures)("validates hardened contract for %s", fixture => {
