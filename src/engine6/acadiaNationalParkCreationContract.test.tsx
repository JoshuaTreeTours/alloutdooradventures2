...
import { ACADIA_NATIONAL_PARK_VIATOR_PUBLIC_PRODUCT_CODES } from "./acadiaNationalParkViatorPublicRatings";

(globalThis as { location?: { pathname: string } }).location = {
  pathname: "/",
};

const acadiaFixtures = ENGINE6_VALIDATION_FIXTURES.filter(fixture =>
  ACADIA_NATIONAL_PARK_VIATOR_PUBLIC_PRODUCT_CODES.includes(fixture.productCode)
);
...
describe("Acadia National Park Engine6 creation contract", () => {
  it("covers every selected Acadia product code", () => {
    expect(acadiaFixtures.map(fixture => fixture.productCode).sort()).toEqual(
      [...ACADIA_NATIONAL_PARK_VIATOR_PUBLIC_PRODUCT_CODES].sort()
    );
  });

  it.each(acadiaFixtures)("validates hardened contract for %s", fixture => {
