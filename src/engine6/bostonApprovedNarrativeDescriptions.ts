export const BOSTON_TARGETED_NARRATIVE_DESCRIPTION_PRODUCT_CODES = [
  "3283BWW",
  "3283SSCRUISE",
  "44921P7",
  "3037DUCK",
...
export type BostonTargetedNarrativeDescriptionProductCode =
  (typeof BOSTON_TARGETED_NARRATIVE_DESCRIPTION_PRODUCT_CODES)[number];

export const BOSTON_TARGETED_NARRATIVE_DESCRIPTIONS: Record<
  BostonTargetedNarrativeDescriptionProductCode,
  string
> = {
  "3283BWW":
    "Head offshore from Boston Harbor on a whale watching cruise to Stellwagen Bank National Marine Sanctuary, one of the Atlantic's most dependable feeding grounds for humpbacks, finbacks, and dolphins. A professional naturalist guide narrates the run past Long Wharf and across the harbor as you move between indoor and outdoor decks for photography. The three-and-a-half-hour format balances travel time with extended scanning on the sanctuary grounds. Plan on 3 hours 30 minutes (approx.) for the outing. You'll pause at Long Wharf before the offshore leg toward Stellwagen Bank National Marine Sanctuary.",
  "3283SSCRUISE":
    "See Revolutionary Boston from the water on a narrated historic sightseeing cruise through Boston Harbor and the Inner Harbor islands. From Long Wharf you'll pass the USS Constitution, Bunker Hill Monument, Boston Light, Old North Church, and Castle Island while a professional narrator ties each shoreline landmark to the city's maritime and colonial story. Open deck seating keeps harbor views unobstructed in fair weather. Plan on 1 hour (approx.) for the outing. Visit Long Wharf during the 10 minutes stop. Pass USS Constitution, Bunker Hill Monument, and Boston Light as part of the route.",
  "44921P7":
    "Watch the Boston skyline turn gold on a narrated sunset harbor cruise departing from Long Wharf. Captain commentary connects Charlestown Navy Yard, the Seaport District, and the harbor islands as daylight fades over the city. Open deck seating and a professional narrator keep the 90-minute format focused on waterfront views rather than transit logistics. Plan on 1 hour 30 minutes (approx.) for the outing. Visit Long Wharf during the 10 minutes stop. Visit Boston Harbor during the 45 minutes stop. Pass Charlestown Navy Yard and the Seaport District as part of the route.",
  "3037DUCK":
    "See Revolutionary Boston from land and water aboard an amphibious WWII-style Duck vehicle led by a professional conDUCKtor guide. The route rolls past Boston Common, the Massachusetts State House, and Faneuil Hall before splashing into the Charles River for views of the Esplanade and Back Bay skyline. The compact format suits first-time visitors who want both street-level landmarks and a river segment without switching vehicles. Plan on 1 hour 20 minutes (approx.) for the outing. Pass Boston Common, Massachusetts State House, and Faneuil Hall as part of the route.",
  "66111P3":
    "Walk the Freedom Trail with a historian guide who brings Revolutionary Boston to life at each granite marker on a small-group outing capped at sixteen guests. Starting from Boston Common, the route covers Massachusetts State House viewpoints, Granary Burying Ground, Faneuil Hall, Paul Revere House, and Old North Church before finishing near Copp's Hill Terrace in the North End. The pace allows deeper stops than a self-guided walk while keeping downtown and North End neighborhoods connected in one booking. Plan on 2 hours 30 minutes (approx.) for the outing.",
  "26797P4":
...
export const getBostonTargetedNarrativeDescription = (productCode: string) =>
  BOSTON_TARGETED_NARRATIVE_DESCRIPTIONS[
    productCode as BostonTargetedNarrativeDescriptionProductCode
  ];
