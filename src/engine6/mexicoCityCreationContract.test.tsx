...
import { MEXICO_CITY_VIATOR_PUBLIC_PRODUCT_CODES } from "./mexicoCityViatorPublicRatings";

(globalThis as { location?: { pathname: string } }).location = {
  pathname: "/",
};

const mexicoCityFixtures = ENGINE6_VALIDATION_FIXTURES.filter(fixture =>
...
describe("Mexico City Engine6 creation contract", () => {
  it("covers every selected Mexico City product code", () => {
    expect(mexicoCityFixtures.map(fixture => fixture.productCode).sort()).toEqual(
      [...MEXICO_CITY_VIATOR_PUBLIC_PRODUCT_CODES].sort()
    );
  });

  it.each(mexicoCityFixtures)("validates hardened contract for %s", fixture => {
