...
> = {
  ...
  "3351P13": () =>
    "Ride through the Coachella Valley on a guided downhill bike adventure focused on the dramatic geology of Earthquake Canyon near Palm Springs. This point-to-point experience pairs sustained descending terrain with broad desert views while your guide shares context about the San Andreas Fault system, canyon landforms, and how tectonic forces shaped this landscape. The route is designed as an accessible, structured outdoor outing with logistics and pacing managed for mixed-experience riders, making it a practical way to explore desert scenery and regional earth science in one trip.",
  "3351P15": () =>
