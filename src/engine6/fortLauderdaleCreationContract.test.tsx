...
const fortLauderdaleFixtures = ENGINE6_VALIDATION_FIXTURES.filter(
  fixture =>
    NEW_FORT_LAUDERDALE_PRODUCT_CODES.includes(
      fixture.productCode as (typeof NEW_FORT_LAUDERDALE_PRODUCT_CODES)[number]
    )
);
...
describe("Fort Lauderdale Engine6 creation contract", () => {
  it.each(fortLauderdaleFixtures)("validates hardened contract for %s", fixture => {
