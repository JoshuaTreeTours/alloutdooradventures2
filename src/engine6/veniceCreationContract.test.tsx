...
import { VENICE_VIATOR_PUBLIC_PRODUCT_CODES } from "./veniceViatorPublicRatings";

(globalThis as { location?: { pathname: string } }).location = {
  pathname: "/",
};

const veniceFixtures = ENGINE6_VALIDATION_FIXTURES.filter(fixture =>
...
describe("Venice Engine6 creation contract", () => {
  it("covers every selected Venice product code", () => {
    expect(veniceFixtures.map(fixture => fixture.productCode).sort()).toEqual(
      [...VENICE_VIATOR_PUBLIC_PRODUCT_CODES].sort()
    );
  });

  it.each(veniceFixtures)("validates hardened contract for %s", fixture => {
