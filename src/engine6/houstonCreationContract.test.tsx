...
import { HOUSTON_VIATOR_PUBLIC_PRODUCT_CODES } from "./houstonViatorPublicRatings";

(globalThis as { location?: { pathname: string } }).location = {
  pathname: "/",
};

const houstonFixtures = ENGINE6_VALIDATION_FIXTURES.filter(fixture =>
  HOUSTON_VIATOR_PUBLIC_PRODUCT_CODES.includes(fixture.productCode)
);
...
describe("Houston Engine6 creation contract", () => {
  it.each(houstonFixtures)("validates hardened contract for %s", fixture => {
