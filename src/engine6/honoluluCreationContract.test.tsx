...
import { HONOLULU_VIATOR_PUBLIC_PRODUCT_CODES } from "./honoluluViatorPublicRatings";

(globalThis as { location?: { pathname: string } }).location = {
  pathname: "/",
};

const honoluluFixtures = ENGINE6_VALIDATION_FIXTURES.filter(fixture =>
  HONOLULU_VIATOR_PUBLIC_PRODUCT_CODES.includes(fixture.productCode)
);
...
describe("Honolulu Engine6 creation contract", () => {
  it.each(honoluluFixtures)("validates hardened contract for %s", fixture => {
