...
import { BOULDER_VIATOR_PUBLIC_PRODUCT_CODES } from "./boulderViatorPublicRatings";

(globalThis as { location?: { pathname: string } }).location = {
  pathname: "/",
};

const boulderFixtures = ENGINE6_VALIDATION_FIXTURES.filter(fixture =>
  BOULDER_VIATOR_PUBLIC_PRODUCT_CODES.includes(fixture.productCode)
);
...
describe("Boulder Engine6 creation contract", () => {
  it.each(boulderFixtures)("validates hardened contract for %s", fixture => {
