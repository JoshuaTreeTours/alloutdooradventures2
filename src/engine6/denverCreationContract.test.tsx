...
import { DENVER_VIATOR_PUBLIC_PRODUCT_CODES } from "./denverViatorPublicRatings";

(globalThis as { location?: { pathname: string } }).location = {
  pathname: "/",
};

const denverFixtures = ENGINE6_VALIDATION_FIXTURES.filter(fixture =>
  DENVER_VIATOR_PUBLIC_PRODUCT_CODES.includes(fixture.productCode)
);
...
describe("Denver Engine6 creation contract", () => {
  it.each(denverFixtures)("validates hardened contract for %s", fixture => {
