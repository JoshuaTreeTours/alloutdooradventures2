...
export const ENGINE6_HILO_PRICE_PATHS = [
  ...
  "bookingOptions[0].pricing.amount",
  "bookingOptions[0].pricing.fromPrice",
  "bookingOptions[0].pricing.fromPriceFormatted",
  "bookingOptions[0].pricingOptions[0].price",
  "bookingOptions[0].pricingOptions[0].price.amount",
  "bookingOptions[0].pricingOptions[0].price.formatted",
  "bookingOptions[0].pricingOptions[0].price.original",
  "bookingOptions[0].pricingOptions[0].price.partnerNetPrice",
  "bookingOptions[0].pricingOptions[0].price.recommendedRetailPrice",
