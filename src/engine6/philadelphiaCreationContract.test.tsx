...
import { PHILADELPHIA_VIATOR_PUBLIC_PRODUCT_CODES } from "./philadelphiaViatorPublicRatings";

(globalThis as { location?: { pathname: string } }).location = {
  pathname: "/",
};

const philadelphiaFixtures = ENGINE6_VALIDATION_FIXTURES.filter(fixture =>
  PHILADELPHIA_VIATOR_PUBLIC_PRODUCT_CODES.includes(fixture.productCode)
);
...
describe("Philadelphia Engine6 creation contract", () => {
  it.each(philadelphiaFixtures)("validates hardened contract for %s", fixture => {
