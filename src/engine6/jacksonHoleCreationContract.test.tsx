...
const jacksonHoleFixtures = ENGINE6_VALIDATION_FIXTURES.filter(fixture =>
  JACKSON_HOLE_VIATOR_PUBLIC_PRODUCT_CODES.includes(fixture.productCode)
);
...
describe("Jackson Hole Engine6 creation contract", () => {
  it.each(jacksonHoleFixtures)("validates hardened contract for %s", fixture => {
