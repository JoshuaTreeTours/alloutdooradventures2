...
import { CABO_SAN_LUCAS_VIATOR_PUBLIC_PRODUCT_CODES } from "./caboSanLucasViatorPublicRatings";

(globalThis as { location?: { pathname: string } }).location = {
  pathname: "/",
};

const caboSanLucasFixtures = ENGINE6_VALIDATION_FIXTURES.filter(fixture =>
...
describe("Cabo San Lucas Engine6 creation contract", () => {
  it("covers every selected Cabo San Lucas product code", () => {
    expect(caboSanLucasFixtures.map(fixture => fixture.productCode).sort()).toEqual(
      [...CABO_SAN_LUCAS_VIATOR_PUBLIC_PRODUCT_CODES].sort()
    );
  });

  it.each(caboSanLucasFixtures)("validates hardened contract for %s", fixture => {
