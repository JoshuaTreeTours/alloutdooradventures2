...
import { PARIS_VIATOR_PUBLIC_PRODUCT_CODES } from "./parisViatorPublicRatings";

(globalThis as { location?: { pathname: string } }).location = {
  pathname: "/",
};

const parisFixtures = ENGINE6_VALIDATION_FIXTURES.filter(fixture =>
...
describe("Paris Engine6 creation contract", () => {
  it("covers every selected Paris product code", () => {
    expect(parisFixtures.map(fixture => fixture.productCode).sort()).toEqual(
      [...PARIS_VIATOR_PUBLIC_PRODUCT_CODES].sort()
    );
  });

  it.each(parisFixtures)("validates hardened contract for %s", fixture => {
