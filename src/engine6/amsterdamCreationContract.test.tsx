...
import { AMSTERDAM_VIATOR_PUBLIC_PRODUCT_CODES } from "./amsterdamViatorPublicRatings";

(globalThis as { location?: { pathname: string } }).location = {
  pathname: "/",
};

const amsterdamFixtures = ENGINE6_VALIDATION_FIXTURES.filter(fixture =>
...
describe("Amsterdam Engine6 creation contract", () => {
  it("covers every selected Amsterdam product code", () => {
    expect(amsterdamFixtures.map(fixture => fixture.productCode).sort()).toEqual(
      [...AMSTERDAM_VIATOR_PUBLIC_PRODUCT_CODES].sort()
    );
  });

  it.each(amsterdamFixtures)("validates hardened contract for %s", fixture => {
