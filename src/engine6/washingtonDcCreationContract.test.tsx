...
import { WASHINGTON_DC_VIATOR_PUBLIC_PRODUCT_CODES } from "./washingtonDcViatorPublicRatings";

(globalThis as { location?: { pathname: string } }).location = {
  pathname: "/",
};

const washingtonDcFixtures = ENGINE6_VALIDATION_FIXTURES.filter(fixture =>
  WASHINGTON_DC_VIATOR_PUBLIC_PRODUCT_CODES.includes(fixture.productCode)
);
...
describe("Washington D.C. Engine6 creation contract", () => {
  it.each(washingtonDcFixtures)(
