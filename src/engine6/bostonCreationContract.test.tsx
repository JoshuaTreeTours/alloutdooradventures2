...
import { BOSTON_VIATOR_PUBLIC_PRODUCT_CODES } from "./bostonViatorPublicRatings";

(globalThis as { location?: { pathname: string } }).location = {
  pathname: "/",
};

const bostonFixtures = ENGINE6_VALIDATION_FIXTURES.filter(fixture =>
  BOSTON_VIATOR_PUBLIC_PRODUCT_CODES.includes(fixture.productCode)
);
...
describe("Boston Engine6 creation contract", () => {
  it.each(bostonFixtures)("validates hardened contract for %s", fixture => {
