...
const keyWestFixtures = ENGINE6_VALIDATION_FIXTURES.filter(fixture =>
  KEY_WEST_VIATOR_PUBLIC_PRODUCT_CODES.includes(fixture.productCode)
);
...
describe("Key West Engine6 creation contract", () => {
  it.each(keyWestFixtures)("validates hardened contract for %s", fixture => {
