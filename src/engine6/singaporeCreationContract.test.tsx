...
const singaporeFixtures = ENGINE6_VALIDATION_FIXTURES.filter(fixture =>
...
describe("Singapore Engine6 creation contract", () => {
  it("covers every selected Singapore product code", () => {
    expect(singaporeFixtures.map(fixture => fixture.productCode).sort()).toEqual(
      [...SINGAPORE_VIATOR_PUBLIC_PRODUCT_CODES].sort()
    );
  });

  it.each(singaporeFixtures)("validates hardened contract for %s", fixture => {
