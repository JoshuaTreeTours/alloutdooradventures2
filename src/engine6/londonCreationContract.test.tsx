...
import { LONDON_VIATOR_PUBLIC_PRODUCT_CODES } from "./londonViatorPublicRatings";

(globalThis as { location?: { pathname: string } }).location = {
  pathname: "/",
};

const londonFixtures = ENGINE6_VALIDATION_FIXTURES.filter(fixture =>
...
describe("London Engine6 creation contract", () => {
  it("covers every selected London product code", () => {
    expect(londonFixtures.map(fixture => fixture.productCode).sort()).toEqual(
      [...LONDON_VIATOR_PUBLIC_PRODUCT_CODES].sort()
    );
  });

  it.each(londonFixtures)("validates hardened contract for %s", fixture => {
