...
import { CUSCO_VIATOR_PUBLIC_PRODUCT_CODES } from "./cuscoViatorPublicRatings";
...
describe("Cusco Engine6 creation contract", () => {
  it("covers every selected Cusco product code", () => {
