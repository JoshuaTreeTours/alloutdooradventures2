...
import { CANCUN_VIATOR_PUBLIC_PRODUCT_CODES } from "./cancunViatorPublicRatings";

(globalThis as { location?: { pathname: string } }).location = {
  pathname: "/",
};

const cancunFixtures = ENGINE6_VALIDATION_FIXTURES.filter(fixture =>
...
describe("Cancun Engine6 creation contract", () => {
  it("covers every selected Cancun product code", () => {
    expect(cancunFixtures.map(fixture => fixture.productCode).sort()).toEqual(
      [...CANCUN_VIATOR_PUBLIC_PRODUCT_CODES].sort()
    );
  });

  it.each(cancunFixtures)("validates hardened contract for %s", fixture => {
