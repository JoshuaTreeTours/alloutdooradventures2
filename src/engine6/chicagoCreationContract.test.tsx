...
const chicagoFixtures = ENGINE6_VALIDATION_FIXTURES.filter(fixture =>
  CHICAGO_VIATOR_PUBLIC_PRODUCT_CODES.includes(fixture.productCode)
);
...
describe("Chicago Engine6 creation contract", () => {
  it.each(chicagoFixtures)("validates hardened contract for %s", fixture => {
