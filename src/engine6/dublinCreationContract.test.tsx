...
import { DUBLIN_VIATOR_PUBLIC_PRODUCT_CODES } from "./dublinViatorPublicRatings";

(globalThis as { location?: { pathname: string } }).location = {
  pathname: "/",
};

const dublinFixtures = ENGINE6_VALIDATION_FIXTURES.filter(fixture =>
...
describe("Dublin Engine6 creation contract", () => {
  it("covers every selected Dublin product code", () => {
    expect(dublinFixtures.map(fixture => fixture.productCode).sort()).toEqual(
      [...DUBLIN_VIATOR_PUBLIC_PRODUCT_CODES].sort()
    );
  });

  it.each(dublinFixtures)("validates hardened contract for %s", fixture => {
