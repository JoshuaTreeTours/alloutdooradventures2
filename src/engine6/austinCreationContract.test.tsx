...
import { AUSTIN_VIATOR_PUBLIC_PRODUCT_CODES } from "./austinViatorPublicRatings";

(globalThis as { location?: { pathname: string } }).location = {
  pathname: "/",
};

const austinFixtures = ENGINE6_VALIDATION_FIXTURES.filter(fixture =>
  AUSTIN_VIATOR_PUBLIC_PRODUCT_CODES.includes(fixture.productCode)
);
...
describe("Austin Engine6 creation contract", () => {
  it.each(austinFixtures)("validates hardened contract for %s", fixture => {
