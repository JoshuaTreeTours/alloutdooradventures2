...
import { KYOTO_VIATOR_PUBLIC_PRODUCT_CODES } from "./kyotoViatorPublicRatings";

(globalThis as { location?: { pathname: string } }).location = {
  pathname: "/",
};

const kyotoFixtures = ENGINE6_VALIDATION_FIXTURES.filter(fixture =>
...
describe("Kyoto Engine6 creation contract", () => {
  it("covers every selected Kyoto product code", () => {
    expect(kyotoFixtures.map(fixture => fixture.productCode).sort()).toEqual(
      [...KYOTO_VIATOR_PUBLIC_PRODUCT_CODES].sort()
    );
  });

  it.each(kyotoFixtures)("validates hardened contract for %s", fixture => {
