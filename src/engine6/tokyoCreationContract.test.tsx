...
const tokyoFixtures = ENGINE6_VALIDATION_FIXTURES.filter(fixture =>
...
describe("Tokyo Engine6 creation contract", () => {
  it("covers every selected Tokyo product code", () => {
    expect(tokyoFixtures.map(fixture => fixture.productCode).sort()).toEqual(
      [...TOKYO_VIATOR_PUBLIC_PRODUCT_CODES].sort()
    );
  });

  it.each(tokyoFixtures)("validates hardened contract for %s", fixture => {
