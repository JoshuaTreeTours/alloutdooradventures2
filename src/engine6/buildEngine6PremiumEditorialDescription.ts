...
export const ENGINE6_EDITORIAL_FORBIDDEN_PATTERNS = [
  ...
  /\bnot wheelchair\b/i,
  /\bservice animal\b/i,
  /\bservice animals allowed\b/i,
  /\bpublic transportation options are available nearby\b/i,
  /\bcancellation policy\b/i,
  /\bfree cancellation\b/i,
  /\bnot recommended for travelers\b/i,
  /\bnot recommended for pregnant travelers\b/i,
  /\binfants and small children can ride in a pram or stroller\b/i,
...
export const ENGINE6_EDITORIAL_METADATA_PATTERNS = [
  ...
  /\bplease call our office\b/i,
  /\bcontact number is international\b/i,
  /\bminimum numbers apply\b/i,
  /\bminimum of \d+ participants\b/i,
  /\bsingle traveler\b/i,
  /\bchildren under\b/i,
  /\bmust be accompanied by an adult\b/i,
  /\bdry bags\b/i,
  /\bpersonal gear\b/i,
  /\bsun screen\b/i,
  /\bsunglasses\b/i,
  /\bhat with a brim\b/i,
  /\bwater bottle\b/i,
  /\bwet shoes\b/i,
  /\bswim suit\b/i,
  /\bsweatshirt\b/i,
  /\bbeach towel\b/i,
  /\bwaterproof camera\b/i,
  /\bpolyester shirt\b/i,
  /\bdouble kayaks\b/i,
  /\brelease forms\b/i,
  /\badventure company\b/i,
  /\b805-\d/i,
  /\bcancellation after confirmation\b/i,
  /\bwheelchair, cane or walker\b/i,
  /\bbraces, splints or casts\b/i,
  /\bmust be able to swim\b/i,
