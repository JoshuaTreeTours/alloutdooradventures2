...
const orlandoFixtures = ENGINE6_VALIDATION_FIXTURES.filter(fixture =>
  ORLANDO_VIATOR_PUBLIC_PRODUCT_CODES.includes(fixture.productCode)
);
...
describe("Orlando Engine6 creation contract", () => {
  it.each(orlandoFixtures)("validates hardened contract for %s", fixture => {
