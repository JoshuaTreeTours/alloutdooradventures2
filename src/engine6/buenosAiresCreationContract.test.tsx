...
import { BUENOS_AIRES_VIATOR_PUBLIC_PRODUCT_CODES } from "./buenosAiresViatorPublicRatings";

(globalThis as { location?: { pathname: string } }).location = {
  pathname: "/",
};

const buenosAiresFixtures = ENGINE6_VALIDATION_FIXTURES.filter(fixture =>
  BUENOS_AIRES_VIATOR_PUBLIC_PRODUCT_CODES.includes(fixture.productCode)
);
...
describe("Buenos Aires Engine6 creation contract", () => {
  it("covers every selected Buenos Aires product code", () => {
    expect(buenosAiresFixtures.map(fixture => fixture.productCode).sort()).toEqual(
      [...BUENOS_AIRES_VIATOR_PUBLIC_PRODUCT_CODES].sort()
    );
  });

  it.each(buenosAiresFixtures)("validates hardened contract for %s", fixture => {
