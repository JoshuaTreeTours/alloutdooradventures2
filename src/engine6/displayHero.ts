...
export const ENGINE6_OSAKA_CANONICAL_CITY_HERO_URL =
...
export const ENGINE6_SEOUL_CANONICAL_CITY_HERO_URL =
  "https://media.tacdn.com/media/attractions-splice-spp-674x446/07/c2/be/80.jpg";

export const ENGINE6_SYDNEY_CANONICAL_CITY_HERO_URL =
  "https://media.tacdn.com/media/attractions-splice-spp-674x446/12/4c/0b/2b.jpg";

export const ENGINE6_CAIRNS_CANONICAL_CITY_HERO_URL =
...
const CANONICAL_CITY_HEROES: Record<string, Record<string, string>> = {
  ...
  japan: {
    ...
    osaka: ENGINE6_OSAKA_CANONICAL_CITY_HERO_URL,
  },
  thailand: {
  ...
  "south-korea": {
    seoul: ENGINE6_SEOUL_CANONICAL_CITY_HERO_URL,
  },
  australia: {
