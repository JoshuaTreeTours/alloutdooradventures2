...
export const buildTourCopy = ({
  ...
  const experienceText = [
    `${name} with ${provider} is designed for travelers who want more than a quick photo stop in ${city}. This experience combines local storytelling, practical route planning, and time to explore the landscapes that define ${city}, ${region}.`,
  ...
  const metaDescription = `${name} in ${city}, ${region} with ${provider}. Guided experience, clear logistics, and memorable local stops.`;
