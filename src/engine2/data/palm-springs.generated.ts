const palmSpringsTours = [
  {
    ...
    "seo": {
      ...
      "description": "Shared San Andreas Fault Jeep Tour in Palm Springs, California with Desert Adventures Red Jeep Tours. Guided experience, clear logistics, and memorable local stops.",
