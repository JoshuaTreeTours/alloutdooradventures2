const WIKI_PHRASE_REPLACEMENTS: Array<[RegExp, string]> = [
  ...
  [/practical stop/gi, "notable site"],
  [/orientation point/gi, "landmark"],
  [/high-impact stop/gi, "noteworthy destination"],
  [/travelers comparing/gi, "visitors exploring"],
  [/balanced itinerary/gi, "city itinerary"],
  [/easy recommendation/gi, "recommended stop"],
