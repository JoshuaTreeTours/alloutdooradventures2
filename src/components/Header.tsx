        ...
        {mobileOpen ? (
          <div className="border-t border-black/10 pb-6 pt-4 md:hidden">
            <nav className="flex flex-col gap-4 text-sm text-[#405040]">
              ...
              <a
                href="tel:18553148687"
                aria-label="Contact us for a Custom Tour – 855-314-TOUR"
                onClick={closeMobileMenu}
              ...
              >
                ...
                <span className="flex flex-col gap-1 text-[#1f2a1f]">
                  <span className="text-sm font-semibold">
                    Contact us for a Custom Tour
                  </span>
                  <span className="text-sm font-semibold text-[#2f4a2f] whitespace-nowrap">
                    855-314-TOUR
                  </span>
                  <span className="text-xs text-[#7a8a6b]">
                    (855) 314-8687
                  </span>
                </span>
              </a>
