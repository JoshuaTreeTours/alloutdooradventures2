...
describe("buildViatorAffiliateUrl", () => {
  it("prefers canonical baseUrl when available", () => {
    const url = buildViatorAffiliateUrl({
      baseUrl:
        "https://www.viator.com/tours/Palm-Springs/Joshua-Tree-Hummer-Adventure-from-Palm-Desert/d648-6740P7",
      fallbackUrl: "https://www.viator.com/tours/Palm-Springs/example",
    });

    expect(url).toBe(
      "https://www.viator.com/tours/Palm-Springs/Joshua-Tree-Hummer-Adventure-from-Palm-Desert/d648-6740P7?pid=P00290915&mcid=42383&medium=link"
    );
  });
  ...
  it("enforces canonical d648 path for a supplied product code", () => {
    const url = buildViatorAffiliateUrl({
      baseUrl:
