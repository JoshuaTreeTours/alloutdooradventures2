...
import catalog from "./barcelona-product-catalog.json";
...
if (newUrls.length === 0) {
  console.log("Sitemap already contains Barcelona tour URLs.");
  process.exit(0);
}
...
console.log(`Appended ${newUrls.length} Barcelona sitemap URLs.`);
