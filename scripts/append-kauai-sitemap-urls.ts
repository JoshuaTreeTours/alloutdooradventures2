...
import catalog from "./kauai-product-catalog.json";
...
if (newUrls.length === 0) {
  console.log("Sitemap already contains Kauai tour URLs.");
  process.exit(0);
}
...
console.log(`Appended ${newUrls.length} Kauai sitemap URLs.`);
