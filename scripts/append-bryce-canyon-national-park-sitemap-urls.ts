...
import catalog from "./bryce-canyon-national-park-product-catalog.json";
...
if (newUrls.length === 0) {
  console.log(
    "Sitemap already contains Bryce Canyon National Park tour URLs."
  );
  process.exit(0);
}
...
console.log(
  `Appended ${newUrls.length} Bryce Canyon National Park sitemap URLs.`
);
