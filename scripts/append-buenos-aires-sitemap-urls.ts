...
import catalog from "./buenos-aires-product-catalog.json";
...
if (newUrls.length === 0) {
  console.log("Sitemap already contains Buenos Aires tour URLs.");
  process.exit(0);
}
...
console.log(`Appended ${newUrls.length} Buenos Aires sitemap URLs.`);
