...
import catalog from "./philadelphia-product-catalog.json";
...
if (newUrls.length === 0) {
  console.log("Sitemap already contains Philadelphia tour URLs.");
  process.exit(0);
}
...
console.log(`Appended ${newUrls.length} Philadelphia sitemap URLs.`);
