...
import catalog from "./melbourne-product-catalog.json";
...
if (newUrls.length === 0) {
  console.log("Sitemap already contains Melbourne tour URLs.");
  process.exit(0);
}
...
console.log(`Appended ${newUrls.length} Melbourne sitemap URLs.`);
