...
import catalog from "./boulder-product-catalog.json";
...
if (newUrls.length === 0) {
  console.log("Sitemap already contains Boulder tour URLs.");
  process.exit(0);
}
...
console.log(`Appended ${newUrls.length} Boulder sitemap URLs.`);
