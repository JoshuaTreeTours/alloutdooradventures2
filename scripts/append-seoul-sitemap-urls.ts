...
import catalog from "./seoul-product-catalog.json";
...
if (newUrls.length === 0) {
  console.log("Sitemap already contains Seoul tour URLs.");
  process.exit(0);
}
...
console.log(`Appended ${newUrls.length} Seoul sitemap URLs.`);
