...
import catalog from "./puerto-vallarta-product-catalog.json";
...
if (newUrls.length === 0) {
  console.log(
    "Sitemap already contains Puerto Vallarta tour URLs."
  );
  process.exit(0);
}
...
console.log(
  `Appended ${newUrls.length} Puerto Vallarta sitemap URLs.`
);
