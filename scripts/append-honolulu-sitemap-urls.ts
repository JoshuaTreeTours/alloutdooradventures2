...
import catalog from "./honolulu-product-catalog.json";
...
if (newUrls.length === 0) {
  console.log("Sitemap already contains Honolulu tour URLs.");
  process.exit(0);
}
...
console.log(`Appended ${newUrls.length} Honolulu sitemap URLs.`);
