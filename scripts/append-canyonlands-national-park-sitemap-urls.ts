...
import catalog from "./canyonlands-national-park-product-catalog.json";
...
if (newUrls.length === 0) {
  console.log(
    "Sitemap already contains Canyonlands National Park tour URLs."
  );
  process.exit(0);
}
...
console.log(
  `Appended ${newUrls.length} Canyonlands National Park sitemap URLs.`
);
