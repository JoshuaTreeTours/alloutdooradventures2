...
import catalog from "./denver-product-catalog.json";
...
if (newUrls.length === 0) {
  console.log("Sitemap already contains Denver tour URLs.");
  process.exit(0);
}
...
console.log(`Appended ${newUrls.length} Denver sitemap URLs.`);
