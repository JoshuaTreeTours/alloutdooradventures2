/**
 * Live Viator public-page discovery for Sydney (d357).
 * Run: npx tsx scripts/discover-sydney-viator-catalog.ts
 */
...
const CATALOG_URLS = [
  "https://www.viator.com/Sydney/d357-ttd",
  "https://www.viator.com/Sydney-tours/Private-and-Custom-Tours/d357-g26",
  "https://www.viator.com/Sydney-tours/Walking-Tours/d357-g16-c56",
  "https://www.viator.com/Sydney-tours/Bike-Tours/d357-g16-c57",
  "https://www.viator.com/Sydney-tours/Food-Tours/d357-g6-c80",
  "https://www.viator.com/Sydney-tours/Day-Trips-and-Excursions/d357-g5",
  "https://www.viator.com/Sydney-tours/Full-day-Tours/d357-g12-c94",
  "https://www.viator.com/Sydney-tours/Half-day-Tours/d357-g12-c95",
  "https://www.viator.com/Sydney-tours/Cultural-and-Theme-Tours/d357-g6",
  "https://www.viator.com/Sydney-tours/Historical-and-Heritage-Tours/d357-g6-c15",
  "https://www.viator.com/Sydney-tours/Photography-Tours/d357-g12-c9",
  "https://www.viator.com/Sydney-tours/Hiking-and-Camping/d357-g9-c35",
  "https://www.viator.com/Sydney-tours/Adventure-Tours/d357-g12-c13",
  "https://www.viator.com/Sydney-tours/Cruises-Sailing-and-Water-Tours/d357-g4",
  "https://www.viator.com/Sydney-tours/Water-Sports/d357-g21",
  "https://www.viator.com/Sydney-tours/Helicopter-Tours/d357-g1-c2",
  "https://www.viator.com/Sydney-tours/Sightseeing-Tours/d357-g12",
  "https://www.viator.com/Sydney-tours/Night-Tours/d357-g12-c11",
  "https://www.viator.com/Sydney-tours/Wine-Tasting-and-Winery-Tours/d357-g6-c81",
  "https://www.viator.com/Sydney-tours/Cultural-Tours/d357-g6-c10",
];

const SEEDED_PRODUCTS: Array<{ productCode: string; sourceUrl: string }> = [];

const PRODUCT_URL_PATTERNS = [
  /https:\/\/www\.viator\.com\/tours\/(?:Sydney|Blue-Mountains|Hunter-Valley|Bondi|Manly|Parramatta)\/[^"'\s]+?\/d(?:357|358|23166|20725)-([A-Z0-9_]+)/gi,
  /\/tours\/(?:Sydney|Blue-Mountains|Hunter-Valley|Bondi|Manly|Parramatta)\/[^"'\s]+?\/d(?:357|358|23166|20725)-([A-Z0-9_]+)/gi,
  /https:\/\/www\.viator\.com\/tours\/[^/"'\s]+\/[^"'\s]+?\/d357-([A-Z0-9_]+)/gi,
  /\/tours\/[^/"'\s]+\/[^"'\s]+?\/d357-([A-Z0-9_]+)/gi,
];

const REJECT_TITLE_PATTERN =
  /audio|self[- ]?guided|gps|app[- ]?based|smartphone|download|hop[- ]?on|admission ticket only|skip the line ticket only|e-ticket only|transfer only|airport transfer|private driver without|car rental|opera house tickets? only|bridgeclimb ticket only|attraction ticket only|entry ticket only|pass only/i;

const PREFERRED_PATTERN =
  /private|food|wine|hunter valley|blue mountain|harbour|harbor|opera house|bridge|bondi|manly|photography|photo|bike|cycling|hike|hiking|cultural|aboriginal|indigenous|historical|night|cruise|boat|kayak|helicopter|licensed|walking|sailing|wildlife/i;

const PREMIUM_PATTERN =
  /private|luxury|helicopter|yacht|photography|photo|licensed|full[- ]?day|charter|bridgeclimb|bridge climb|premium|small[- ]?group/i;
...
const main = async () => {
  ...
  for (const candidate of candidates) {
    try {
      ...
      const sanityRejected =
        ...
        !/helicopter|private|luxury|charter|multi[- ]?day|yacht|bridgeclimb/i.test(
          haystack
        );
      const localMislabeled =
        ...
        !/helicopter|luxury|charter|multi[- ]?day|yacht|bridgeclimb/i.test(
          haystack
        );
      const audMislabeled =
  ...
  writeFileSync(
    "scripts/sydney-viator-discovery-results.json",
    `${JSON.stringify(
      {
  ...
  writeFileSync(
    "scripts/sydney-live-product-data.raw.json",
