...
import catalog from "./arches-national-park-product-catalog.json";
...
if (newUrls.length === 0) {
  console.log(
    "Sitemap already contains Arches National Park tour URLs."
  );
  process.exit(0);
}
...
console.log(
  `Appended ${newUrls.length} Arches National Park sitemap URLs.`
);
