...
import catalog from "./houston-product-catalog.json";
...
if (newUrls.length === 0) {
  console.log("Sitemap already contains Houston tour URLs.");
  process.exit(0);
}
...
console.log(`Appended ${newUrls.length} Houston sitemap URLs.`);
