...
import catalog from "./rocky-mountain-national-park-product-catalog.json";
...
if (newUrls.length === 0) {
  console.log(
    "Sitemap already contains Rocky Mountain National Park tour URLs."
  );
  process.exit(0);
}
...
console.log(
  `Appended ${newUrls.length} Rocky Mountain National Park sitemap URLs.`
);
