...
import catalog from "./chicago-product-catalog.json";
...
if (newUrls.length === 0) {
  console.log("Sitemap already contains Chicago tour URLs.");
  process.exit(0);
}
...
console.log(`Appended ${newUrls.length} Chicago sitemap URLs.`);
