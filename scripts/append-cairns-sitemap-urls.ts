...
import catalog from "./cairns-product-catalog.json";
...
if (newUrls.length === 0) {
  console.log("Sitemap already contains Cairns tour URLs.");
  process.exit(0);
}
...
console.log(`Appended ${newUrls.length} Cairns sitemap URLs.`);
