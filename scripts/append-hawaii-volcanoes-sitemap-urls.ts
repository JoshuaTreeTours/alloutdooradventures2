...
import catalog from "./hawaii-volcanoes-product-catalog.json";
...
if (newUrls.length === 0) {
  console.log(
    "Sitemap already contains Hawaii Volcanoes National Park tour URLs."
  );
  process.exit(0);
}
...
console.log(
  `Appended ${newUrls.length} Hawaii Volcanoes National Park sitemap URLs.`
);
