...
import catalog from "./boston-product-catalog.json";
...
if (newUrls.length === 0) {
  console.log("Sitemap already contains Boston tour URLs.");
  process.exit(0);
}
...
console.log(`Appended ${newUrls.length} Boston sitemap URLs.`);
