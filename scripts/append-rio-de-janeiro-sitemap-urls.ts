...
import catalog from "./rio-de-janeiro-product-catalog.json";
...
if (newUrls.length === 0) {
  console.log(
    "Sitemap already contains Rio de Janeiro tour URLs."
  );
  process.exit(0);
}
...
console.log(
  `Appended ${newUrls.length} Rio de Janeiro sitemap URLs.`
);
