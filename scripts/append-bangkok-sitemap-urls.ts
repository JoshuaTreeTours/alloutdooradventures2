...
import catalog from "./bangkok-product-catalog.json";
...
if (newUrls.length === 0) {
  console.log("Sitemap already contains Bangkok tour URLs.");
  process.exit(0);
}
...
console.log(`Appended ${newUrls.length} Bangkok sitemap URLs.`);
