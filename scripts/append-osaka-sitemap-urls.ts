...
import catalog from "./osaka-product-catalog.json";
...
if (newUrls.length === 0) {
  console.log("Sitemap already contains Osaka tour URLs.");
  process.exit(0);
}
...
console.log(`Appended ${newUrls.length} Osaka sitemap URLs.`);
