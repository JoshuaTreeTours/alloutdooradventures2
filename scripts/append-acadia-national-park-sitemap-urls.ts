...
import catalog from "./acadia-national-park-product-catalog.json";
...
if (newUrls.length === 0) {
  console.log(
    "Sitemap already contains Acadia National Park tour URLs."
  );
  process.exit(0);
}
...
console.log(
  `Appended ${newUrls.length} Acadia National Park sitemap URLs.`
);
