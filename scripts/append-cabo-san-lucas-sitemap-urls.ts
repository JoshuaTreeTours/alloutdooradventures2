...
import catalog from "./cabo-san-lucas-product-catalog.json";
...
if (newUrls.length === 0) {
  console.log(
    "Sitemap already contains Cabo San Lucas tour URLs."
  );
  process.exit(0);
}
...
console.log(
  `Appended ${newUrls.length} Cabo San Lucas sitemap URLs.`
);
