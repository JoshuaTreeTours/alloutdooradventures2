...
import catalog from "./jackson-hole-product-catalog.json";
...
if (newUrls.length === 0) {
  console.log("Sitemap already contains Jackson Hole tour URLs.");
  process.exit(0);
}
...
console.log(`Appended ${newUrls.length} Jackson Hole sitemap URLs.`);
