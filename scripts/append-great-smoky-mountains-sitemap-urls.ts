...
import catalog from "./great-smoky-mountains-product-catalog.json";
...
if (newUrls.length === 0) {
  console.log("Sitemap already contains Great Smoky Mountains tour URLs.");
  process.exit(0);
}
...
console.log(`Appended ${newUrls.length} Great Smoky Mountains sitemap URLs.`);
