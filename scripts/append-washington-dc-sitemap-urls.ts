...
import catalog from "./washington-dc-product-catalog.json";
...
if (newUrls.length === 0) {
  console.log("Sitemap already contains Washington D.C. tour URLs.");
  process.exit(0);
}
...
console.log(`Appended ${newUrls.length} Washington D.C. sitemap URLs.`);
