...
import catalog from "./austin-product-catalog.json";
...
if (newUrls.length === 0) {
  console.log("Sitemap already contains Austin tour URLs.");
  process.exit(0);
}
...
console.log(`Appended ${newUrls.length} Austin sitemap URLs.`);
