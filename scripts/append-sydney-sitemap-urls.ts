...
import catalog from "./sydney-product-catalog.json";
...
if (newUrls.length === 0) {
  console.log("Sitemap already contains Sydney tour URLs.");
  process.exit(0);
}
...
console.log(`Appended ${newUrls.length} Sydney sitemap URLs.`);
