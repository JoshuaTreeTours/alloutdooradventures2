...
import catalog from "./key-west-product-catalog.json";
...
if (newUrls.length === 0) {
  console.log("Sitemap already contains Key West tour URLs.");
  process.exit(0);
}
...
console.log(`Appended ${newUrls.length} Key West sitemap URLs.`);
