/**
 * Playwright extraction of Honolulu Viator catalog product links.
 * Run: npx tsx scripts/extract-honolulu-catalog-browser.ts
 */
...
const EXTRACT_CATALOG_JS = `(() => {
  ...
  const slugPatterns = ["Honolulu", "Oahu", "Hawaii"];
