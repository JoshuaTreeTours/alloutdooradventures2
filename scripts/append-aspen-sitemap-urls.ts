...
import catalog from "./aspen-product-catalog.json";
...
if (newUrls.length === 0) {
  console.log("Sitemap already contains Aspen tour URLs.");
  process.exit(0);
}
...
console.log(`Appended ${newUrls.length} Aspen sitemap URLs.`);
