/**
 * Live Viator public-page discovery for Bali (d98).
 * Run: npx tsx scripts/discover-bali-viator-catalog.ts
 */
...
const CATALOG_URLS = [
  ...
  "https://www.viator.com/Bali-tours/Private-and-Custom-Tours/d98-g26",
  "https://www.viator.com/Bali-tours/Bike-Tours/d98-g16-c57",
  "https://www.viator.com/Bali-tours/Walking-Tours/d98-g16-c56",
  "https://www.viator.com/Bali-tours/Food-Tours/d98-g6-c80",
  "https://www.viator.com/Bali-tours/Day-Trips-and-Excursions/d98-g5",
  "https://www.viator.com/Bali-tours/Full-day-Tours/d98-g12-c94",
  "https://www.viator.com/Bali-tours/Cultural-and-Theme-Tours/d98-g6",
  "https://www.viator.com/Bali-tours/Helicopter-Tours/d98-g1-c2",
  "https://www.viator.com/Bali-tours/Cruises-Sailing-and-Water-Tours/d98-g4",
  "https://www.viator.com/Bali-tours/Photography-Tours/d98-g12-c9",
  "https://www.viator.com/Bali-tours/Hiking-and-Camping/d98-g9-c35",
  "https://www.viator.com/Bali-tours/Adventure-Tours/d98-g12-c13",
  "https://www.viator.com/Bali-tours/Half-day-Tours/d98-g12-c95",
  "https://www.viator.com/Bali-tours/Historical-and-Heritage-Tours/d98-g6-c15",
  "https://www.viator.com/Bali-tours/Water-Sports/d98-g21",
  "https://www.viator.com/Bali-tours/Snorkeling/d98-g21-c51",
  "https://www.viator.com/Bali-tours/4WD-ATV-and-Off-Road-Tours/d98-g12-c47",
  "https://www.viator.com/Ubud/d959-ttd",
  "https://www.viator.com/Ubud-tours/Food-Tours/d959-g6-c80",
  "https://www.viator.com/Ubud-tours/Hiking-and-Camping/d959-g9-c35",
];

const SEEDED_PRODUCTS: Array<{ productCode: string; sourceUrl: string }> = [
  {
    productCode: "2280P109",
    sourceUrl:
      "https://www.viator.com/tours/Ubud/Mount-Batur-Sunrise-Trekking-and-Natural-Hot-Spring/d959-2280P109",
  },
  {
    productCode: "3841P5",
    sourceUrl:
      "https://www.viator.com/tours/Bali/Nusa-Penida-Day-Trip-West-and-East/d98-3841P5",
  },
  {
    productCode: "5643P13",
    sourceUrl:
      "https://www.viator.com/tours/Ubud/Ubud-Countryside-Cycling-Tour/d959-5643P13",
  },
];

const PRODUCT_URL_PATTERNS = [
  /https:\/\/www\.viator\.com\/tours\/(?:Bali|Ubud|Seminyak|Canggu|Uluwatu|Kuta|Nusa-Dua|Sanur)\/[^"'\s]+?\/d(?:98|959|5118|5119)-([A-Z0-9_]+)/gi,
  /\/tours\/(?:Bali|Ubud|Seminyak|Canggu|Uluwatu|Kuta|Nusa-Dua|Sanur)\/[^"'\s]+?\/d(?:98|959|5118|5119)-([A-Z0-9_]+)/gi,
];

const REJECT_TITLE_PATTERN =
  /audio|self[- ]?guided|gps|app[- ]?based|smartphone|download|hop[- ]?on|admission ticket only|skip the line ticket only|e-ticket only|transfer only|airport transfer|private driver without|car rental/i;

const PREFERRED_PATTERN =
  /private|jeep|4x4|off[- ]?road|atv|helicopter|wine|coffee|photography|photo|stargaz|hike|hiking|trek|bike|cycling|food|cooking|cultural|uluwatu|kecak|batur|penida|rafting|snorkel|dive|temple|ubud|rice terrace|swing|waterfall/i;

const PREMIUM_PATTERN =
  /private|luxury|helicopter|yacht|sailing|photography|photo|stargaz|full[- ]?day|licensed|sunrise trek|nusa penida/i;
...
const extractFromHtml = (html: string) => {
  ...
  const audMatch = html.match(/From\s*(?:AU\$|A\$)\s*([0-9][0-9,]*(?:\.[0-9]{2})?)/i);
  ...
  const localCurrencyDetected = Boolean(
    idrMatch ||
      ...
      gbpMatch ||
      audMatch ||
      /From\s*(?:CA\$|AU\$|A\$|R\$|S\/|MX\$|NZ\$|SGD|ZAR|DKK)/i.test(html)
  );
  ...
  const usdConfirmed = Boolean(
    fromUsMatch ||
      (/From\s*\$/.test(html) &&
        ...
        !/From\s*(?:€|£|CA\$|AU\$|A\$|฿|¥|Rp|IDR)/.test(html))
  );
  ...
  return {
    ...
    usdConfirmed,
    localCurrencyDetected,
    idrAmount: idrMatch ? idrMatch[1] : null,
...
const main = async () => {
  ...
  writeFileSync(
    "scripts/bali-viator-discovery-results.json",
    `${JSON.stringify(
      {
  ...
  writeFileSync(
    "scripts/bali-live-product-data.raw.json",
