...
import catalog from "./naples-product-catalog.json";
...
if (newUrls.length === 0) {
  console.log("Sitemap already contains Naples tour URLs.");
  process.exit(0);
}
...
console.log(`Appended ${newUrls.length} Naples sitemap URLs.`);
