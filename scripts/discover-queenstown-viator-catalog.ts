/**
 * Live Viator public-page discovery for Queenstown, New Zealand (d407).
 * Run: npx tsx scripts/discover-queenstown-viator-catalog.ts
 */
...
const CATALOG_URLS = [
  "https://www.viator.com/Queenstown/d407-ttd",
  "https://www.viator.com/Queenstown-tours/Private-and-Custom-Tours/d407-g26",
  "https://www.viator.com/Queenstown-tours/Walking-Tours/d407-g16-c56",
  "https://www.viator.com/Queenstown-tours/Bike-Tours/d407-g16-c57",
  "https://www.viator.com/Queenstown-tours/Food-Tours/d407-g6-c80",
  "https://www.viator.com/Queenstown-tours/Day-Trips-and-Excursions/d407-g5",
  "https://www.viator.com/Queenstown-tours/Full-day-Tours/d407-g12-c94",
  "https://www.viator.com/Queenstown-tours/Half-day-Tours/d407-g12-c95",
  "https://www.viator.com/Queenstown-tours/Cultural-and-Theme-Tours/d407-g6",
  "https://www.viator.com/Queenstown-tours/Historical-and-Heritage-Tours/d407-g6-c15",
  "https://www.viator.com/Queenstown-tours/Photography-Tours/d407-g12-c9",
  "https://www.viator.com/Queenstown-tours/Hiking-and-Camping/d407-g9-c35",
  "https://www.viator.com/Queenstown-tours/Adventure-Tours/d407-g12-c13",
  "https://www.viator.com/Queenstown-tours/Cruises-Sailing-and-Water-Tours/d407-g4",
  "https://www.viator.com/Queenstown-tours/Water-Sports/d407-g21",
  "https://www.viator.com/Queenstown-tours/Helicopter-Tours/d407-g1-c2",
  "https://www.viator.com/Queenstown-tours/Air-Tours/d407-g1",
  "https://www.viator.com/Queenstown-tours/Sightseeing-Tours/d407-g12",
  "https://www.viator.com/Queenstown-tours/Night-Tours/d407-g12-c11",
  "https://www.viator.com/Queenstown-tours/Wine-Tasting-and-Winery-Tours/d407-g6-c81",
  "https://www.viator.com/Queenstown-tours/Cultural-Tours/d407-g6-c10",
  "https://www.viator.com/Queenstown-tours/Nature-and-Wildlife/d407-g12-c8",
  "https://www.viator.com/Queenstown-tours/Eco-Tours/d407-g12-c22",
  "https://www.viator.com/Queenstown-tours/4WD-ATV-and-Off-Road-Tours/d407-g12-c7",
  "https://www.viator.com/Queenstown-tours/Jet-Boats/d407-g4-c32",
  "https://www.viator.com/Queenstown-tours/Skip-the-Line-Tours/d407-g12-c22450",
  "https://www.viator.com/Queenstown-tours/Scenic-Railways/d407-g12-c96",
  "https://www.viator.com/Queenstown-attractions/Milford-Sound/d407-a239",
  "https://www.viator.com/Queenstown-attractions/Shotover-River/d407-a240",
  "https://www.viator.com/Queenstown-attractions/Glenorchy/d407-a241",
];

const SEEDED_PRODUCTS: Array<{ productCode: string; sourceUrl: string }> = [];

const PRODUCT_URL_PATTERNS = [
  /https:\/\/www\.viator\.com\/tours\/(?:Queenstown|Milford-Sound|Glenorchy|Wanaka|Arrowtown|Te-Anau|Fiordland|Skippers-Canyon|Remarkables|Lake-Wakatipu|Gibbston|Cromwell|Otago)\/[^"'\s]+?\/d(?:407|408|409|411|412|413|23168|5285|5286|5287)-([A-Z0-9_]+)/gi,
  /\/tours\/(?:Queenstown|Milford-Sound|Glenorchy|Wanaka|Arrowtown|Te-Anau|Fiordland|Skippers-Canyon|Remarkables|Lake-Wakatipu|Gibbston|Cromwell|Otago)\/[^"'\s]+?\/d(?:407|408|409|411|412|413|23168|5285|5286|5287)-([A-Z0-9_]+)/gi,
  /https:\/\/www\.viator\.com\/tours\/[^/"'\s]+\/[^"'\s]+?\/d407-([A-Z0-9_]+)/gi,
  /\/tours\/[^/"'\s]+\/[^"'\s]+?\/d407-([A-Z0-9_]+)/gi,
];

const REJECT_TITLE_PATTERN =
  /audio|self[- ]?guided|gps|app[- ]?based|smartphone|download|hop[- ]?on|admission ticket only|skip the line ticket only|e-ticket only|transfer only|airport transfer|private driver without|car rental|attraction ticket only|entry ticket only|pass only|rental only|equipment rental|ski pass|lift ticket only/i;

const PREFERRED_PATTERN =
  /private|food|wine|milford|doubtful|glenorchy|shotover|dart|earnslaw|walter peak|skyline|gondola|arrowtown|skippers|remarkable|wakatipu|photography|photo|bike|cycling|hike|hiking|cultural|maori|māori|indigenous|historical|night|cruise|boat|kayak|jet|helicopter|walking|sailing|wildlife|stargazing|star|fiordland|bungy|canyon|wine|gibbston/i;

const PREMIUM_PATTERN =
  /private|luxury|helicopter|yacht|photography|photo|licensed|full[- ]?day|charter|premium|small[- ]?group|scenic flight|milford sound|doubtful sound|overnight|canyon swing|bungy/i;
...
const main = async () => {
  ...
  writeFileSync(
    "scripts/queenstown-viator-discovery-results.json",
    `${JSON.stringify(
      {
  ...
  writeFileSync(
    "scripts/queenstown-live-product-data.raw.json",
