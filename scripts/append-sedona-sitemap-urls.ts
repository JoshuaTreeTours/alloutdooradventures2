...
import catalog from "./sedona-product-catalog.json";
...
if (newUrls.length === 0) {
  console.log("Sitemap already contains Sedona tour URLs.");
  process.exit(0);
}
...
console.log(`Appended ${newUrls.length} Sedona sitemap URLs.`);
