...
import catalog from "./glacier-product-catalog.json";
...
if (newUrls.length === 0) {
  console.log("Sitemap already contains Glacier tour URLs.");
  process.exit(0);
}
...
console.log(`Appended ${newUrls.length} Glacier sitemap URLs.`);
