...
import catalog from "./orlando-product-catalog.json";
...
if (newUrls.length === 0) {
  console.log("Sitemap already contains Orlando tour URLs.");
  process.exit(0);
}
...
console.log(`Appended ${newUrls.length} Orlando sitemap URLs.`);
